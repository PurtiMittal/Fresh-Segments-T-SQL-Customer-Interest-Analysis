...
-- Count of rows having null as month_year is 1194
...
-- Result returns clean rows with no unexpected nulls in the key columns, confirming the join logic is sound and we can proceed with this approach.
